/**
 * PLEASE copypasterino the contents of this file into a config.ts with the information properly filled out.
 * PLEASE make a config.ts for every machine you to develop on.
