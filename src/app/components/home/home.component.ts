...
export class HomeComponent implements OnInit, OnDestroy, AfterViewInit {
	...
	announcement = 'MyMICDS now has a Twitter! <a class="alert-link" href="https://twitter.com/MyMICDS" target="_blank">Follow @MyMICDS</a> to get news on the latest features, announcements, and more!';
